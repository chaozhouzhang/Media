...
public class BufferActivity extends AppCompatActivity implements SurfaceHolder.Callback, PreviewCallback {

    private static final String TAG = "lidongxiu";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mStopRecord = findViewById(R.id.stop_record);
        getMediaCodecList();
    ...
    private void init() {
        ...
        WindowManager wm = (WindowManager) BufferActivity.this.getSystemService(Context.WINDOW_SERVICE);
